...
const nothingTheme = {
  ...
  components: {
    Card:       { colorBgContainer: '#2a2a2a', boxShadow: 'none' },
    Tabs:       { itemColor: '#999999', itemActiveColor: '#ffffff', itemHoverColor: '#ffffff', inkBarColor: '#ffffff' },
    Tooltip:    { colorBgSpotlight: '#303030', colorTextLightSolid: '#ffffff' },
    Switch:     { colorPrimary: '#ff6b1a', colorPrimaryHover: '#ff6b1a' },
